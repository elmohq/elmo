...
| Provider | Why | Rough cost per prompt/month |
|---|---|---|
| [**Cloro**](https://cloro.dev?fpr=elmo) | Asynchronous task API covering every surface Elmo scrapes. Credit-based plans from $30/mo. | ~$0.65 |
| [**BrightData**](https://get.brightdata.com/67h1b7h0shcn) | Cheapest solid option. Battle-tested dataset collectors for each major AI surface. | ~$0.45 |
| [**Oxylabs**](https://oxylabs.go2cloud.org/aff_c?offer_id=7&aff_id=2263&url_id=32) | Asynchronous Push-Pull API. Good for ChatGPT, Perplexity, and both Google surfaces. | pay-as-you-go |
| [**Olostep**](https://olostep.com/?ref=elmo) | Powers most large-scale AI visibility trackers today. Good reliability at scale. | ~$2.25 |
| [**DataForSEO**](https://dataforseo.com/?aff=184966) | One account reaches the real ChatGPT and Gemini UIs plus both Google surfaces. No subscription. | pay-as-you-go |
...
- [**Cloro**](https://cloro.dev?fpr=elmo) — sells credits on a monthly plan rather than per request. ChatGPT costs 7 credits and Google AI Mode 4, so those 300 evaluations run ≈1,650 credits/mo → **$0.65/mo per prompt** on its mid-tier plans, nearer $1.30 on the $30 entry plan. Because the plan fee is fixed, a handful of prompts costs the same as a plan's worth.
- [**BrightData**](https://get.brightdata.com/67h1b7h0shcn) — list price of about $0.0015 per evaluation → **$0.45/mo per prompt**.
- [**Oxylabs**](https://oxylabs.go2cloud.org/aff_c?offer_id=7&aff_id=2263&url_id=32) — Web Scraper API pricing depends on the plan.
- [**Olostep**](https://olostep.com/?ref=elmo) — roughly 5× BrightData → **$2.25/mo per prompt**.
- [**DataForSEO**](https://dataforseo.com/?aff=184966) — priced per call with no subscription, and each surface bills differently.

Actual cost depends on volume tier and provider promos. The provider links above are Elmo's affiliate links — they give us a small kickback and cost you nothing extra.
</Callout>
