...
3. **AI Providers** — Configure scrapers ([Cloro](https://affiliate.cloro.dev/elmo?sid=docs), [BrightData](https://get.brightdata.com/elmo?sid=docs), [Oxylabs](https://oxylabs.go2cloud.org/aff_c?offer_id=7&aff_id=2263&url_id=32), [SearchApi](https://www.searchapi.io/?via=elmo), [Olostep](https://olostep.com/?ref=elmo), [DataForSEO](https://dataforseo.com/?aff=184966)) and/or direct model APIs (OpenAI, Anthropic, Mistral, OpenRouter); see [Providers](/docs/user-guide/providers) for details
4. **Public URL** — Where you'll open Elmo; keep the localhost default unless you're serving it from a domain (see [Serving Elmo from a Domain](/docs/developer-guide/configuration#serving-elmo-from-a-domain))
5. **Start** — Optionally start the stack immediately
