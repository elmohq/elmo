...
4. **Access** — Use Elmo on this machine (localhost), or from a domain behind a reverse proxy (see [Serving Elmo from a Domain](/docs/developer-guide/configuration#serving-elmo-from-a-domain))
