...
The same reference is browsable inside the app at **Settings → API**, where it reads the deployment's
own spec — every instance serves that spec at `/api/v1/openapi.json`.
