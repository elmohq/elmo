...
itemList:
  ...
  - name: GetCito
    description: "A rebranded fork of Elmo's codebase since July 2026, shipped with Elmo's copyright notice replaced."
  - name: Gego
...
There is no reason to run a rebranded fork of a project you can run directly, especially one that is falling behind it: 17 commits to Elmo's 98 in the month after the copy. Full evidence in [GetCito vs Elmo](/blog/getcito-vs-elmo).
