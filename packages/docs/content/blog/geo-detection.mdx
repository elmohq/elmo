...
For the fundamentals, start with [what AI citations are](/blog/ai-citations) and [how to track your brand in AI search](/answer-engine-optimization). For the arms-race context, read [citation wars](/blog/citation-wars) and our data on [citation volatility](/blog/citation-volatility). For the vocabulary, the [AI search glossary](/glossary).
