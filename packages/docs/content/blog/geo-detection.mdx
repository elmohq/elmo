...
| | |
|---|---|
| GEO prevalence across retrieved pages | **8.90%** (95% CI 8.36–9.47) of 10,095 pages, 1,000 real queries — [CISPA, arXiv:2608.16824](https://arxiv.org/abs/2608.16824) |
| Among pages last modified in 2026 | **16.36%** — one page in six |
| Trend by year of last modification | 2024 **7.02%** → 2025 **12.80%** → 2026 **16.36%** |
| Gemini-grounded vs Google Search results | **9.09% vs 8.14%**, widening to 18.20% vs 13.52% on 2026 pages |
| Spread by domain | **20.37%** of sampled Amazon pages · 4.38% YouTube · **0%** Wikipedia and major medical sites |
| Citations on detected GEO pages failing a verifiability audit | **69.34%** of 6,663 citation occurrences |
| Best detector, aggregate F1 / worst-group accuracy | **0.944 / 0.883** with intervention-paired training |
...
## How much of the web is actually GEO-optimized?
...
First, the trend line. Prevalence more than doubles between pages last touched in 2024 and pages last touched in 2026. Whatever else is true, the window in which doing GEO made you unusual is closing: among the freshest content competing for retrieval, one page in six already carries detectable optimization. That matters because tactic effectiveness is a function of how many competitors run the same tactic — a [Capital One simulation](https://arxiv.org/abs/2608.27631) found fixed single tactics scoring *below* the unoptimized baseline once 80% of competing documents are optimized, which makes this prevalence figure the x-axis for [whether your GEO playbook still pays](/blog/do-geo-tactics-stop-working). (The year-by-year figures come from the 1,976 sampled pages carrying modification metadata, so they're the softest numbers in the paper — but the direction is steep enough to survive the caveat.)
...
## Do GEO detectors actually detect optimization?
...
## What do the citations on optimized pages point at?
