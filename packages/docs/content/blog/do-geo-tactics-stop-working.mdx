...
| | |
|---|---|
| Fixed single tactics at 80% competitor adoption | **Score below the unoptimized baseline** — [Capital One, arXiv:2608.27631](https://arxiv.org/abs/2608.27631) |
...
| Measured real-world GEO prevalence | **8.90%** of pages overall, **16.36%** of pages modified in 2026 — [CISPA, arXiv:2608.16824](https://arxiv.org/abs/2608.16824) |
...
| CHASE: quality–ranking alignment over 20 rounds | **mean Δρ −0.068** across six domains, control ≈ 0 — [arXiv:2608.30466](https://arxiv.org/abs/2608.30466) |
...
**On this page:** [The missing question](#why-do-geo-tactic-rankings-assume-competitors-hold-still) · [What the paper did](#what-did-the-paper-actually-do) · [The adoption experiment](#what-happens-as-competitors-adopt-the-same-tactics) · [Where is your category?](#so-where-is-your-category-on-that-curve) · [What repeated rounds do](#what-do-repeated-rounds-do-to-the-pool-itself) · [The accuracy cost](#what-does-optimizing-cost-you-in-accuracy) · [Limits](#what-this-does-not-show) · [What to do](#what-to-do-on-monday)
...
Four independent groups now converge on this. The [mechanism-design work on citation wars](/blog/citation-wars) found unsupported claims accumulating over repeated optimization rounds. The GEO-Flag audit found decoration-grade citations on 69% of the pages it detected as optimized. This paper measures the faithfulness cost directly. And the CHASE result above is the population-level rhyme: the same pressure decouples the ranking signal from quality for everyone at once. Pushed hard enough, visibility optimization manufactures unsupported claims.
