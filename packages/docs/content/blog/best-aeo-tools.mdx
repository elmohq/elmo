...
itemList:
  ...
  - name: GetCito
    description: "A rebadged copy of Elmo's codebase since July 2026; run Elmo directly instead."
faq:
...
| **GetCito** | Nothing — run Elmo instead | A copy of Elmo's codebase, rebadged in July 2026 | Open source, free |
...
The practical consequence is simple: GetCito cannot offer a feature Elmo does not already have, and it ships slower — 17 commits to Elmo's 98 in the month after the copy. The AI Crawlability Clinic it was previously known for belonged to the old application and was deleted. Evidence and links in [GetCito vs Elmo](/blog/getcito-vs-elmo).
