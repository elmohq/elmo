...
For the fundamentals, start with [AI citations](/blog/ai-citations) and [answer engine optimization](/answer-engine-optimization), then [how to track your brand in AI search](/answer-engine-optimization). For how much citations move on a daily timescale, see [citation volatility](/blog/citation-volatility); for the gap between being cited and being named, see [ghost citations](/blog/ghost-citations). For the vocabulary, see the [AI search glossary](/glossary).
