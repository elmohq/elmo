...
For anyone doing [answer engine optimization](/answer-engine-optimization), that is a more useful signal than another ranking factor. It splits a piece of advice that has always been treated as one thing:
