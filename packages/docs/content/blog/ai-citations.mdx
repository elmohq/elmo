...
- Citation share is measurable, and the clearest signal that your [AEO](/answer-engine-optimization) is working.
...
Done together, these make your content the kind of source an answer engine reaches for, and they're the core of [answer engine optimization](/answer-engine-optimization).
