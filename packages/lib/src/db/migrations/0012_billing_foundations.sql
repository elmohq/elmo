CREATE TYPE "public"."claude_mode" AS ENUM('base', 'web');--> statement-breakpoint
CREATE TABLE "organization_settings" (
	"organization_id" text PRIMARY KEY NOT NULL,
	"entitlement_overrides" jsonb,
	"claude_addon_quantity" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "prompts" ADD COLUMN "claude_mode" "claude_mode";--> statement-breakpoint
