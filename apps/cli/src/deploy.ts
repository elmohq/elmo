...
import { link, printBanner } from "./core/ui.js";
import { withVersionCheck } from "./core/version.js";
...
export function registerDeployCommands(program: Command, version: string): void {
	program
		.command("init")
