...
export const HOME_FAQS: FaqItem[] = [
	...
	},
	{
		...
		answer:
			'Track the questions a real buyer would ask an AI assistant before choosing a product like yours — for example "best tool for X", "X vs Y", or "how do I solve Z" — not just searches for your brand name. Elmo\'s Prompt Wizard drafts these from your website, keywords, competitors, and buyer personas, and you can edit them, add your own, and tag them for filtering. Elmo Cloud plans include 50 to 350 tracked prompts, and self-hosted Elmo has no prompt limit.',
	},
	{
		question: "Can I track my competitors in AI search with Elmo?",
		answer:
			"Yes. Elmo suggests competitors when you set up a brand, and you can add or edit them at any time. For every prompt, it shows which competitors each AI engine mentioned, ranks brands by share of voice, and shows which competitor domains are being cited. That tells you where rivals are being recommended instead of you.",
	},
	{
		question: "How long does it take to see results with Elmo?",
		answer:
			"Elmo shows your first visibility data as soon as its first scheduled run finishes, usually within minutes of adding your prompts. A reliable baseline takes a few weeks of repeated sampling, because individual AI answers vary. Changes from new content or third-party mentions show up in Elmo's trend charts over the following weeks and months, and its Opportunities page ranks what to work on next.",
	},
	{
	...
	{
		question: "Can agencies use Elmo for clients?",
		answer:
			"Yes. Agencies can track several client brands on Elmo Cloud (up to 5 on the Business plan) with unlimited seats, and share reports with clients via a link, no login needed. For agencies that want to resell AI visibility tracking, Elmo offers white-label deployments with custom branding, a custom domain, SSO, and multi-organization support.",
	},
	{
