...
export function CompetitorDirectory({ showHero = true }: { showHero?: boolean } = {}) {
	...
	return (
		<>
			{/* Hero — suppressed when the directory is embedded under a page that
			    already provides the H1 (e.g. the AI visibility software hub). */}
			{showHero && (
