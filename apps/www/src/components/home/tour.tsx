			...
			<div className="mx-auto max-w-6xl px-4 py-20 md:px-6 lg:py-28">
				<div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
					...
					<a
						...
						className="group inline-flex shrink-0 items-center gap-1 text-sm font-medium text-zinc-700 hover:text-zinc-950 md:mb-2"
					>
				...
				<div className="mt-12 grid gap-10 lg:mt-16 lg:grid-cols-12 lg:items-start lg:gap-12">
					<div className="lg:col-span-4">
						{groups.map((group) => (
							<div key={group.name} className="mb-5 last:mb-0">
								<p className="mb-2 px-3 text-xs font-medium text-zinc-400">{group.name}</p>
					...
					<div className="sticky top-24 hidden lg:col-span-8 lg:block">
						<div className="rounded-3xl bg-gradient-to-br from-blue-50 via-zinc-50 to-zinc-50 p-5 ring-1 ring-zinc-200/70">
							{all.map((f) => (
