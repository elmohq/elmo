		...
		<section className="border-t border-zinc-200 bg-zinc-50/70">
			<div className="mx-auto max-w-6xl px-4 py-16 md:px-6 lg:py-20">
				<div className="grid gap-4 lg:grid-cols-12 lg:items-end lg:gap-12">
					<div className="lg:col-span-6">
						...
						<h2 className="mt-4 text-[2rem] font-semibold leading-[1.08] tracking-[-0.03em] text-balance text-zinc-950 md:text-[2.75rem]">
							The engines your buyers ask.
						</h2>
					</div>
					<p className="max-w-[56ch] text-pretty text-base/7 text-zinc-600 lg:col-span-6 lg:pb-1.5">
						Elmo Cloud reads ChatGPT, Google AI Mode, AI Overviews, Copilot, Perplexity and Gemini the way users see
						them, and calls the APIs for Claude, DeepSeek, Mistral and more. Self-hosted, point it at any model through
						OpenRouter or your own keys.
					</p>
				</div>
				<ul className="mt-10 grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-5 md:gap-3">
					{MODELS.map((m) => {
						...
						return (
							<li
								key={m.name}
								className="flex h-12 items-center gap-3 rounded-xl bg-white px-4 shadow-[0_0_0_1px_rgb(24_24_27/0.07),0_1px_2px_rgb(24_24_27/0.04)] md:h-14"
							>
				...
				<p className="mt-5 text-center text-[13px] text-zinc-500">
					Plus any other model via OpenRouter when you self-host.
				</p>
			</div>
		</section>
	);
