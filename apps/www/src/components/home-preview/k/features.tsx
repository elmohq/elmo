		...
		<section id="features" className="bg-white">
			<div className="mx-auto max-w-6xl px-4 py-20 md:px-6 lg:py-28">
				<SectionHeading
					...
					lede="Plans differ by brands, prompts and platforms, never by feature. Measure where you show up, understand why, and act on it."
				/>
				...
				<div className="mt-12 grid gap-10 lg:mt-16 lg:grid-cols-12 lg:items-start lg:gap-12">
					<div className="lg:col-span-4">
						{groups.map((group) => (
							<div key={group.name} className="mb-5 last:mb-0">
								<p className="mb-2 px-3 text-[12px] font-semibold uppercase tracking-[0.08em] text-zinc-400">
									{group.name}
								</p>
					...
					<div className="sticky top-24 hidden lg:col-span-8 lg:block">
						<div className="rounded-3xl bg-[linear-gradient(135deg,rgb(37_99_235),rgb(29_78_216))] p-6 shadow-[0_32px_64px_-32px_rgb(37_99_235/0.6)]">
							{all.map((f) => (
