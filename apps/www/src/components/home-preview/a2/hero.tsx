			...
			<div className="relative mx-auto max-w-6xl px-4 pb-4 pt-14 md:px-6 md:pt-20 lg:pt-24">
				<div className="mx-auto flex max-w-3xl flex-col items-center text-center">
					...
					<button
						...
						className="group mt-5 inline-flex items-center gap-2 rounded-md text-sm font-medium text-zinc-700 transition-colors hover:text-zinc-950 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-blue-600"
					>
				...
				<div className="relative mt-14 md:mt-20 xl:-mx-10">
					<PipelineDiagram />
				</div>
			</div>
