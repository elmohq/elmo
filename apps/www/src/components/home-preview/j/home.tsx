...
.home-j { --font-sans: "Geist A", ui-sans-serif, system-ui, sans-serif; font-family: var(--font-sans); }
.home-j ::selection { background: rgb(37 99 235 / 0.18); }
`;

export function HomeVariantJ() {
	// The shared navbar and footer paint themselves white; recolour them to the page's paper from here
	// rather than forking them.
	return (
		<div className="home-j min-h-screen bg-[#f7f5f0] text-[#1c1a17] antialiased [&>header]:border-[#1c1a17]/12 [&>header]:bg-[#f7f5f0]/85 [&>footer]:border-t [&>footer]:border-[#1c1a17]/12 [&>footer]:bg-transparent">
			<style>{fontCss}</style>
			<Navbar />
			<main>
				<Hero />
