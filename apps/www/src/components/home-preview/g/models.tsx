	...
	return (
		<section className="border-t border-zinc-200 bg-white">
			<div className="mx-auto max-w-6xl px-4 py-16 md:px-6 lg:py-20">
				...
				<ul className="mt-10 grid grid-cols-2 border-t border-zinc-200 sm:grid-cols-3 md:grid-cols-5">
					{MODELS.map((m) => {
						const Icon = m.icon;
						return (
							<li key={m.name} className="flex h-14 items-center gap-3 border-b border-zinc-200 pr-3 md:h-16">
