...
export function LogoStrip() {
	return (
		<section aria-label="Customers" className="relative bg-white">
			<div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
				<p className="text-center text-[13px] text-zinc-500">Trusted by teams tracking their AI visibility</p>
