...
export function Features() {
	...
	const [activeId, setActiveId] = useState("opportunities");
	const baseId = useId();
	...
	return (
		<section id="features" className="scroll-mt-20 bg-white">
			<div className="mx-auto max-w-6xl px-4 py-20 md:px-6 lg:py-28">
				<SectionHeading
					eyebrow="From problem to plan"
					title="See why AI picks them, then fix it."
					lede="Measure where you show up, understand which searches and sources shape each answer, and act on recommendations ranked by impact."
				/>
