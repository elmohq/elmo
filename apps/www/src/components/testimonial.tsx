			...
			<div className="mx-auto max-w-6xl px-4 py-16 md:px-6 lg:py-24">
				...
				<figure className="mt-8 max-w-[48rem]">
					...
					<blockquote className="mt-6 text-pretty text-2xl font-medium leading-[1.4] tracking-tight text-zinc-950 md:text-[2rem] md:leading-[1.35]">
						...
						search, and Elmo was a great fit. It didn’t yet support DataForSEO,
						they were incredibly responsive and quickly added the integration we
						needed.”
					</blockquote>
					<figcaption className="mt-8 flex flex-wrap items-center gap-x-3 gap-y-2">
						<span className="text-sm font-semibold text-zinc-950">James</span>
						<a
							href={TRADESITES_URL}
							target="_blank"
