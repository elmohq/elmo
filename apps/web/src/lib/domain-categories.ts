...
export const PAGE_TYPE_CONFIG: Record<CitationPageType, { label: string; chartColor: string }> = {
	homepage: { label: /* i18n */ "Homepage", chartColor: "#79a8e8" },
	article: { label: /* i18n */ "Article", chartColor: "#2563eb" },
	listicle: { label: /* i18n */ "Listicle", chartColor: "#36b39a" },
	howto: { label: /* i18n */ "Guide", chartColor: "#a463f2" },
	comparison: { label: /* i18n */ "Comparison", chartColor: "#f58518" },
	review: { label: /* i18n */ "Review", chartColor: "#ff8ab7" },
	forum: { label: /* i18n */ "Forum", chartColor: "#11a8cd" },
	video: { label: /* i18n */ "Video", chartColor: "#ef4444" },
	doc: { label: /* i18n */ "Docs", chartColor: "#b279a2" },
	product: { label: /* i18n */ "Storefront", chartColor: "#3ca951" },
	info: { label: /* i18n */ "Info", chartColor: "#efb118" },
	search: { label: /* i18n */ "Search", chartColor: "#b6992d" },
	shopping: { label: /* i18n */ "Shopping", chartColor: "#9c6b4e" },
	other: { label: /* i18n */ "Other", chartColor: "#9498a0" },
};
