...
export const updatePromptTool = defineTool({
	...
	description:
		"Change a prompt's text, tags, or whether it is being sampled. Setting `enabled: false` stops a prompt from using runs and keeps every answer already recorded.",
	scopes: ["write"],
	readOnly: false,
