...
export const fr: Record<string, string> = {
	...
	"Couldn't export the report. Please try again.": "Impossible d'exporter le rapport. Veuillez réessayer.",
	"AI visibility report — {brand}": "Rapport de visibilité IA — {brand}",
	Period: "Période",
	"Generated on": "Généré le",
	"Prompts tracked": "Prompts suivis",
	"Evaluations (30d)": "Évaluations (30 j)",
	"Current AI visibility": "Visibilité IA actuelle",
	"Branded prompts visibility": "Visibilité sur les prompts de marque",
	"Non-branded prompts visibility": "Visibilité sur les prompts hors marque",
	"Current share of voice": "Part de voix actuelle",
	"Total citations": "Total des citations",
	...
	Domain: "Domaine",
	Category: "Catégorie",
	"Top cited pages": "Pages les plus citées",
	URL: "URL",
	"Page title": "Titre de la page",
	"Best platform": "Meilleure IA",
	"Weakest platform": "IA la plus faible",
	"By AI platform": "Par IA",
	"AI platform": "IA",
	Answers: "Réponses",
	"Answers naming the brand": "Réponses citant la marque",
	"Visibility (%)": "Visibilité (%)",
	"Most-named competitor": "Concurrent le plus cité",
	"Leading competitor": "Concurrent en tête",
	"Competitor rate (%)": "Taux du concurrent (%)",
	"Citations of your site": "Citations de votre site",
	"Most-cited domains": "Domaines les plus cités",
	Type: "Type",
	Branded: "Marque",
	"Non-branded": "Hors marque",
	"Gap (pts)": "Écart (pts)",
	"Prompts by AI platform": "Prompts par IA",
	"Competitors by prompt": "Concurrents par prompt",
	"Rate (%)": "Taux (%)",
	Definitions: "Définitions",
	Metric: "Indicateur",
	Meaning: "Signification",
	"Share of AI answers that name the brand. Plain 30-day average, unlike the smoothed trend line.":
		"Part des réponses IA qui citent la marque. Moyenne brute sur 30 jours, contrairement à la courbe lissée du tableau de bord.",
	"Brand mentions divided by all brand and competitor mentions.":
		"Mentions de la marque divisées par l'ensemble des mentions de la marque et des concurrents.",
	"Share of AI answers that name that competitor.": "Part des réponses IA qui citent ce concurrent.",
	"Leading competitor rate minus brand visibility. Positive means the competitor is ahead.":
		"Taux du concurrent en tête moins la visibilité de la marque. Positif : le concurrent est devant.",
	"Sources in the answers that link to the brand's own domains.":
		"Sources des réponses qui pointent vers les domaines de la marque.",
	// @@END
};
