/**
 * The answer engines this deployment knows about.
 *
 ...
 * isn't a platform". An instance with nothing configured yet still gets the
...
export function platformCatalogue(): Platform[] {
