 ...
 *
 * Scoped through the brand's owning organization: the caller must have access
 * to the brand both to start an analysis and to read it back, so a job's
 * output never leaks outside the workspace that requested it.
 */
