/**
 * GET /api/v1/models — the answer engines this deployment can track.
 *
 * Requires no scope. Lets a client build a model filter without hardcoding ids
		...
		handlers: withMethodGuard({
			GET: createApiHandler({
				handle: async () => {
					...
					// run this" from "this isn't a model". An instance with nothing
