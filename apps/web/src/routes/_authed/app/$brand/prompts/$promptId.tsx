...
import { PromptModelsCard } from "@/components/prompt-models-card";
...
function PromptHistoryPage() {
	...
	return (
		<div className="space-y-0">
			...
			{/* PER-PROMPT MODEL CONFIG (self-gated: absent in whitelabel/demo) */}
			<div className="pb-6 empty:hidden">
				<PromptModelsCard brandId={brandId} promptId={promptId} />
			</div>
