	...
	return (
		<div className="max-w-4xl mx-auto p-6 print:pt-8">
				...
				<Card className="print:shadow-none">
					<CardHeader>
						...
						<CardTitle className="text-3xl">
							<span className={`font-bold ${getVisibilityTextColor(averageVisibility)}`}>{averageVisibility}%</span>
						</CardTitle>
					</CardHeader>
				</Card>
			</div>
			...
			<Card className="print:shadow-none mb-6">
				<CardContent className="space-y-3">
					<p className="text-gray-700 text-sm leading-normal">
						<strong>Answer Engine Optimization (AEO)</strong>, also known as Generative Engine Optimization (GEO), is
						the practice of optimizing content to be discovered and cited by AI-powered search engines and chatbots like
						ChatGPT, Claude, Perplexity, and Google's AI Overviews.
					</p>
					<p className="text-gray-700 text-sm leading-normal">
						Unlike traditional SEO which focuses on ranking websites in search results, AEO aims to have your brand
						mentioned directly in AI-generated responses. When users ask questions, AI engines synthesize information
						from the web and provide conversational answers. AEO ensures your brand is part of those answers.
					</p>
					<div className="bg-blue-50 border-l-4 border-blue-400 p-3">
						<p className="text-blue-800 font-medium text-sm">
							Only around 12% of sources cited by ChatGPT overlap with traditional Google search results, meaning most
							traditional SEO strategies may not translate to AI visibility.
						</p>
					</div>
				</CardContent>
			</Card>
			...
			<Card className="print:shadow-none mb-6">
				<CardContent className="space-y-3">
					<p className="text-gray-700 text-sm leading-normal">
						<strong>AI Visibility</strong> measures how often your brand appears in AI-generated responses. It's
						calculated by running relevant prompts through major AI engines and tracking brand mentions.
					</p>
							...
							<CardContent>
								{(() => {
									...
									const brandMentionRatio =
										totalPromptsTracked > 0 ? promptsWithBrandMentions / totalPromptsTracked : 0;
											...
											<table className="w-full text-sm">
												...
												<tbody>
													<tr className="border-b border-gray-100">
														...
														<td className="py-3 px-2 text-sm text-gray-700">{recommendation}</td>
													</tr>
												</tbody>
											</table>
										</div>
					...
					<div>
						<Card className="print:shadow-none">
							<CardHeader>
								...
								<CardDescription className="text-slate-700">
									Prompts where competitors are outperforming {report.brandName} are your biggest opportunities for
									improvement.
								</CardDescription>
							</CardHeader>
							<CardContent>
									...
									const competitiveAnalysis = topPromptsSubset
										.map((item) => {
											...
											for (const competitor of parsedReportData.competitors) {
												const competitorMentions = promptRuns.filter(
													...
													{topOpportunities.map((opportunity, index) => (
														<tr key={index} className="border-b border-gray-100">
															<td className="py-3 px-2 max-w-xs">
																<div className="text-xs text-gray-700 break-words">{opportunity.prompt}</div>
															</td>
															<td className="text-center py-3 px-2">
																<span className="text-xs text-gray-700">{opportunity.brandVisibility}%</span>
															</td>
															<td className="text-center py-3 px-2">
																<span className="text-xs text-gray-700">{opportunity.avgCompetitorVisibility}%</span>
															</td>
															<td className="text-center py-3 px-2">
																<span className="text-xs text-gray-700">{opportunity.goalVisibility}%</span>
															</td>
															<td className="py-3 px-2 text-xs text-gray-700">
																Write{" "}
																{Math.max(
																	1,
																	Math.round(Math.sqrt(opportunity.goalVisibility - opportunity.brandVisibility)),
																)}{" "}
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
							<div className="text-center p-4">
								...
								<p className="text-sm text-slate-700">
									Develop content strategies that increase your brand mentions in AI responses
								</p>
							</div>
							<div className="text-center p-4">
								<div className="flex justify-center mb-2">
