...
Thank you for your interest in contributing to the projects of Blue Whale
Software, LLC ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, please sign it and
send it to Us by mail, email, fax, or electronic submission, following the
instructions in the [How to sign this CLA](#how-to-sign-this-cla) section
below. This is a legally binding document, so please read it carefully
before agreeing to it. The Agreement may cover more than one software
...
the Copyright in the entire work of authorship, please contact Us before
Submitting.
...
portions of such combination). This license is granted only to the extent
that the exercise of the licensed rights infringes such patent claims; and
provided that this license is conditioned upon compliance with Section
2.3.
...
(d) You have contacted Us before Submitting, if You do not own the
...
the laws of Delaware, USA excluding its conflicts of law provisions. Under
...
We use a lightweight, self-service signing flow. You can sign as part of
your first contribution PR — no separate sign-up step required.
...
The CLA check will then pass for this PR and all your future PRs — you
only need to sign once.
...
The Harmony Individual Contributor License Agreement template is © 2011
Project Harmony Authors and is licensed under the
