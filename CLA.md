...
Thank you for your interest in contributing to software projects of Blue Whale
Software, LLC ("We" or "Us"). This Contributor License Agreement ("Agreement")
documents the rights granted by contributors to Us. This Agreement is based on
the Apache Software Foundation Individual Contributor License Agreement (v2.2)
and uses substantially the same legal terms.
...
Copyright in the entire work of authorship, please contact Us before
Submitting.
...
which We are using on the Submission Date for the Material (including any
rights to adopt any future license version(s) as permitted by such license)
or any other license that is approved by the Open Source Initiative on or
after the Effective Date, including but not limited to the GNU Affero
General Public License version 3 (or any later version) under which the
Material is currently distributed.
...
employee, You have had Your employer approve this Agreement or sign the
...
(d) You have followed the instructions in Section 4, if You do not own the
Copyright in the entire work of authorship Submitted.

## 4. Notice to Us

You agree to notify Us in writing of any facts or circumstances of which You
...
DISCLAIMED, SUCH WARRANTY IS LIMITED IN DURATION AND EXTENT TO THE MINIMUM
...
of a party to require such performance at any time in the future. A waiver
of performance under a provision in one situation shall not be considered a
...
We use a lightweight, self-service signing flow. You can sign as part of your
first contribution PR — no separate sign-up step required.

1. In your pull request, add your GitHub username (lowercase, on its own
   line) to [`.github/contributors.txt`](.github/contributors.txt). The
   header of that file explains that adding your username constitutes
   agreement to this CLA, so editing the file is itself the signature.
2. The PR must be opened from your own GitHub account (not on behalf of
   someone else). The merged commit serves as your electronic signature
   and is timestamped by GitHub.

The CLA check will then pass for this PR and all your future PRs — you only
need to sign once.

If you are contributing on behalf of an employer or another legal entity,
please contact us before submitting so we can arrange an Entity CLA.
