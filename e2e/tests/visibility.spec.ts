...
test.describe("Visibility Page", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(`/app/org/${ORG_SLUG}/brand/${BRAND_ID}/visibility`);
  ...
  test("page is accessible via sidebar navigation", async ({ page }) => {
    ...
    const visLink = page.locator(`a[href="/app/org/${ORG_SLUG}/brand/${BRAND_ID}/visibility"][data-sidebar="menu-button"]`);
