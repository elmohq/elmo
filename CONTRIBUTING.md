...
Elmo is licensed under the [MIT License](LICENSE.md). By contributing, you
...
[Contributor License Agreement](CLA.md). The CLA grants Blue Whale Software,
LLC the rights needed to distribute and (if necessary) relicense the
project. You retain copyright in your contributions.
