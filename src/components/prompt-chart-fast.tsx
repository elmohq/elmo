...
import { usePromptChartDataFast } from "@/hooks/use-prompt-chart-data-fast";
...
interface PromptChartFastProps {
...
export function PromptChartFast({
	lookback = "1m",
	promptName,
	promptId,
	brandId,
	...
	enabled = true,
	priority = "normal",
}: PromptChartFastProps) {
	// Use the ultra-fast hook with caching
	const { chartData, isLoading, isError } = usePromptChartDataFast(
		brandId,
		promptId,
		{
			lookback,
